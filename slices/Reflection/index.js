...
const Reflection = ({ slice }) => {
  return (
    ...
    >
      <div className="flex  gap-22.25 font-medium">
        {/* Left */}
        <div>
          <div className="text-[#A59653] font-raleway text-base uppercase ">
          ...
          <div className="text-lg font-raleway tracking-tight">
            <PrismicRichText field={slice.primary.description} />
          </div>
          <div>
            <div
              className="ml-1 mt-3.5 font-raleway rounded-xl p-5 tracking-tight bg-[#F2F3E9] text-xl "
        ...
        <div>
          <div className="grid grid-cols-2 gap-5">
            {slice.primary.categories.map((item, i) => (
              <div key={i} className="border-t-2 border-t-[#A59653]/40 hover:border-t-[#A59653]">
                <div className="flex gap-2.5 mt-7.25 mb-5">
                  <div >
                    <PrismicNextImage field={item.icon} className="w-6.25 h-7.25" />
                  </div>
