...
const HeroSection = ({ slice }) => {
  return (
    <section
      ...
      className=" w-full xl:max-w-385 xl:mx-auto h-full  lg:px-4 rounded-xl  "
    >
      <div className="relative h-dvh xl:h-full  w-full  ">
        ...
        <div className="absolute bottom-0 xl:bottom-45 xl:pl-17.5 px-4 lg:w-[70%] ">
          {/* Eyebrow Heading */}
          ...
          {/* Heading */}
          <div className="font-monsterrat text-4xl md:text-[52px] xl:text-[4.6875rem] text-white leading-[1.15] xl:leading-[1.2] tracking-tight mb-2.5">
            <PrismicRichText field={slice.primary.main_heading} />
          </div>
          <div className="font-raleway text-base md:text-xl xl:text-[1.5625rem] text-white xl:w-[60%]">
